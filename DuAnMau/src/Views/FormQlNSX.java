 ...
 * @author ongbi
 */
public class FormQlNSX extends javax.swing.JFrame {
  private final IQLNSXService iNSXServicel;
    /**
     * Creates new form FormNSX
     */
    public FormQlNSX() {
        initComponents();
        iNSXServicel = new QLNSXService();
        loadTable();
    }
 ...
 private void loadTable() {
        ...
        for (QLNSX qlnsx : this.iNSXServicel.getAll()) {
            Object[] rowData = {
                qlnsx.getId(),
                qlnsx.getMa(),
                qlnsx.getTen()
    ...
    private QLNSX getFormData() {
        ...
        QLNSX qlnsx = new QLNSX(id, maStr, tenStr);
        return qlnsx;
    }
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        QLNSX qlnsx = this.getFormData();

        if (qlnsx == null) {
            return;
        }

        this.iNSXServicel.insert(qlnsx);
        loadTable();
        clearForm();
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        this.iNSXServicel.update(qlnsx, id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormQlNSX.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
