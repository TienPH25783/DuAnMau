 ...
 * @author ongbi
 */
public class FormQLChucVu extends javax.swing.JFrame {

    /**
     * Creates new form FormQLChucVu
     */
    private final IQlChucVuService iChuVuService;
    
    public FormQLChucVu() {
        initComponents();
        iChuVuService = new QLChucVuService();
        loadTable();
    }
 private void loadTable() {
        ...
        for (QLChucVu qLChucVu : this.iChuVuService.getAll()) {
            Object[] rowData = {
                qLChucVu.getId(),
                qLChucVu.getMa(),
                qLChucVu.getTen()
    ...
    private QLChucVu getFormData() {
        ...
        QLChucVu chucVu = new QLChucVu(id, maStr, tenStr);
        return chucVu;
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quản Lý ChucVU");
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        QLChucVu chucVu = this.getFormData();

        if (chucVu == null) {
            return;
        }

        this.iChuVuService.insert(chucVu);
        loadTable();
        clearForm();
    }//GEN-LAST:event_btnThemActionPerformed

    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        QLChucVu qLChucVu = this.getFormData();
        ...
        this.iChuVuService.update(qLChucVu, id);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormQLChucVu.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormQLChucVu().setVisible(true);
            }
        });
    }
